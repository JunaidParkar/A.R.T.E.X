...
ARTEX = os.environ.get('ARTEX')
TEMP_FOLDER = f"{ARTEX}\\Artex\\Temp"

LOCALAPPDATA = os.environ['LOCALAPPDATA']
LOCALFOLDER = f"{LOCALAPPDATA}\\Artex"
